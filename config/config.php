 ...
 */
$GLOBALS['BE_MOD']['content']['audiomax'] = array(
    'tables' => array('tl_audiomax_playlist', 'tl_audiomax_song'),
    'icon' => 'system/modules/audiomax/assets/images/icon.png'
);
 ...
 */
$GLOBALS['FE_MOD']['miscellaneous']['audiomax'] = 'ModuleAudiomaxPlaylist';
 ...
 */
//array_insert($GLOBALS['TL_CTE']['media'], 4, array('audiomax' => 'ContentAudiomaxPlaylist'));
...
// TODO: include minified versions
$GLOBALS['TL_JAVASCRIPT'][] = 'system/modules/audiomax/assets/js/jquery.audiomax.min.js';
$GLOBALS['TL_CSS'][] = 'system/modules/audiomax/assets/css/player.min.css';